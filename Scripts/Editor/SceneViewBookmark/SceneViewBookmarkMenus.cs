...
namespace SceneViewBookmarks
{
    static class SceneViewBookmarkMenus
    {
        ...
        private const string SCENE_VIEW_MENU = MY_TOOLS_MENU + "Scene View Bookmarks/";
        
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 1 %1", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 2 %2", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 3 %3", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 4 %4", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 5 %5", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 6 %6", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 7 %7", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 8 %8", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Move to Bookmark 9 %9", false, 100)]
        ...
        [MenuItem(SCENE_VIEW_MENU + "Return to Previous View %0", false, 200)]
